    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className={`w-full max-w-2xl h-[42rem] rounded-2xl overflow-hidden flex flex-col ${
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-dark-300">
          ...
          <button
            onClick={() => updateUserProfile(session?.user?.email, formData.username, formData.bio, formData.location, formData.website, formData.socialLinks.x, formData.socialLinks.instagram, formData.socialLinks.twitch, formData.favoriteCommunity)}
