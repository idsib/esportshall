        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#" className="text-gray-600 dark:text-gray-300 hover:text-brand-yellow dark:hover:text-brand-yellow transition-colors">
                  Torneos
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:info@esportshall.com" className="text-gray-600 dark:text-gray-300 hover:text-brand-yellow dark:hover:text-brand-yellow transition-colors">
                  info@esportshall.com
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-brand-yellow dark:hover:text-brand-yellow transition-colors">
                  GitHub
                </a>
              </li>
              <li>
