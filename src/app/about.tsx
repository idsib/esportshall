...
import { Trophy, Users, Globe, Target, Award, Rocket } from "lucide-react"
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                        <FeatureCard 
                            ...
                            description="Organizamos y gestionamos torneos de alto nivel para múltiples juegos y niveles de habilidad."
                        />
                        <FeatureCard 
                            icon={<Users />}
                        ...
                        <FeatureCard 
                            ...
                            description="Programas especializados para desarrollar nuevos talentos en el mundo de los esports."
                        />
                        <FeatureCard 
                            icon={<Award />}
                            title="Eventos Exclusivos"
                            description="Acceso a eventos especiales, bootcamps y competiciones premium."
                        />
                        <FeatureCard 
                            icon={<Rocket />}
